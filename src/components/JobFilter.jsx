      ...
      <div className="flex flex-col sm:flex-row gap-6 max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div>
          <form
            ...
            className="bg-[#c1e2e6] p-6 rounded-lg shadow-md w-full sm:w-80"
          >
            ...
            <div className="space-y-2">
              {["Fresher", "1-3 Years", "3-5 Years", "5+ Years"].map(
                (level) => (
            ...
            <button
              type="submit"
              className="w-full bg-teal-600 text-white py-2 rounded-md mt-4"
            >
              Apply
            </button>
          </form>
          ...
          <div>
            <div className="relative w-full sm:w-80 rounded-lg overflow-hidden shadow-md">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR39-uqBf9DFeayUgZLRQzcvvU0iIfos1J69tOq1QaETXSPdcPSbi9JmQKjuWcsiHE6O4k&usqp=CAU"
                alt="We Are Hiring"
                ...
                {currentJobs.map((job) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 mt-3 sm:mt-0">
                      <button
                        className="px-3 sm:px-4 py-1 sm:py-2 bg-teal-600 text-white rounded-md text-sm sm:text-base"
